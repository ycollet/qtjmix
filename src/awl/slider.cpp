...
//---------------------------------------------------------
  ...
  Slider::Slider (QWidget * parent):AbstractSlider (parent),
    orient (Qt::Vertical), _sliderSize (14, 14)
  {
    init ();
  }
...
//---------------------------------------------------------
  ...
  Slider::Slider (Qt::Orientation orientation,
		  QWidget * parent):AbstractSlider (parent),
    orient (orientation), _sliderSize (14, 14)
  {
    init ();
  }
...
//      if (points->boundingRect().toRect().contains(startDrag)) {
    ...
    int pixel =
      (orient ==
       Qt::Vertical) ? height () - _sliderSize.height () : width () -
      _sliderSize.width ();
    dragppos =
      int (pixel * (_value - minValue ()) / (maxValue () - minValue ()));
    if (_invert)
...
//---------------------------------------------------------
  ...
  void Slider::mouseMoveEvent (QMouseEvent * ev)
  {
    ...
    int delta =
      orient ==
      Qt::Horizontal ? (startDrag.x () - ev->x ()) : (startDrag.y () -
						      ev->y ());
...
//            delta = -delta;
    ...
    _value =
      (pos * (maxValue () - minValue ()) / pixel) + minValue () - 0.000001;
    valueChange ();
  }
...
//---------------------------------------------------------
  ...
  void Slider::paintEvent (QPaintEvent * ev)
  {
    ...
    if ((orient == Qt::Vertical && _invert)
	|| (orient == Qt::Horizontal && !_invert))
      ppos = pixel - ppos;
