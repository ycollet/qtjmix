...
//---------------------------------------------------------
  ...
  MeterSlider::MeterSlider (QWidget * parent):VolSlider (parent)
  {
...
//---------------------------------------------------------
  ...
  void MeterSlider::resizeEvent (QResizeEvent * /*ev */ )
  {
    ...
    linearDarkGrad.setColorAt (1 - (double) (h1 - 5) / (double) mh,
			       darkYellRedRed);
    linearDarkGrad.setColorAt (1 - (double) (h1 - 6) / (double) mh,
			       darkYellowRed);
